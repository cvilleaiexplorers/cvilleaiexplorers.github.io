...
3. **Converge (5 min).** Pick one, or combine the best parts of two. Write down *why*. Getting a second opinion on the plan before you build can save time later (see section 2).
